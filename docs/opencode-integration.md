...
将 `packages/opencode-skill/skill.md` 的内容复制到你的 OpenCode Skill 配置目录，或在 `AGENTS.md` 中引用。
...
完整 Skill 定义见 [`packages/opencode-skill/skill.md`](../packages/opencode-skill/skill.md)。
